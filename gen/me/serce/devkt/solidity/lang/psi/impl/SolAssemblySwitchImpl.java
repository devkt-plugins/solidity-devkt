...
public class SolAssemblySwitchImpl extends ASTWrapperPsiElement implements SolAssemblySwitch {

  public SolAssemblySwitchImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitAssemblySwitch(this);
  }
  ...
  @Override
  @NotNull
  public List<SolAssemblyCase> getAssemblyCaseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SolAssemblyCase.class);
  }
