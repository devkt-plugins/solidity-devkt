...
public class SolTupleStatementImpl extends ASTWrapperPsiElement implements SolTupleStatement {

  public SolTupleStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  public SolVariableDeclaration getVariableDeclaration() {
    return findChildByClass(SolVariableDeclaration.class);
  }
