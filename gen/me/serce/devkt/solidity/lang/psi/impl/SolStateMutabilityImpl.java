...
public class SolStateMutabilityImpl extends ASTWrapperPsiElement implements SolStateMutability {

  public SolStateMutabilityImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitStateMutability(this);
  }
