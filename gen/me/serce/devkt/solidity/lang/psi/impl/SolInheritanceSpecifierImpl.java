...
public class SolInheritanceSpecifierImpl extends ASTWrapperPsiElement implements SolInheritanceSpecifier {

  public SolInheritanceSpecifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitInheritanceSpecifier(this);
  }
  ...
  public SolUserDefinedTypeName getUserDefinedTypeName() {
    return findNotNullChildByClass(SolUserDefinedTypeName.class);
  }
