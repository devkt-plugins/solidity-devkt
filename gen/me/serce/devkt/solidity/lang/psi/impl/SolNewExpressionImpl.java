...
public class SolNewExpressionImpl extends SolExpressionImpl implements SolNewExpression {

  public SolNewExpressionImpl(ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getBytesNumType() {
    return findChildByType(BYTESNUMTYPE);
  }
