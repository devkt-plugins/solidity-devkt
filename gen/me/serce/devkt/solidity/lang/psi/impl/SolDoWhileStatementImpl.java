...
public class SolDoWhileStatementImpl extends ASTWrapperPsiElement implements SolDoWhileStatement {

  public SolDoWhileStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SolStatement getStatement() {
    return findChildByClass(SolStatement.class);
  }
