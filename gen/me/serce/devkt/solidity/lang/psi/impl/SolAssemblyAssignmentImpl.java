...
public class SolAssemblyAssignmentImpl extends ASTWrapperPsiElement implements SolAssemblyAssignment {

  public SolAssemblyAssignmentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitAssemblyAssignment(this);
  }
