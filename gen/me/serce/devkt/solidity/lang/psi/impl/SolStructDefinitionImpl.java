...
public class SolStructDefinitionImpl extends ASTWrapperPsiElement implements SolStructDefinition {

  public SolStructDefinitionImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SolVariableDeclaration> getVariableDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SolVariableDeclaration.class);
  }
