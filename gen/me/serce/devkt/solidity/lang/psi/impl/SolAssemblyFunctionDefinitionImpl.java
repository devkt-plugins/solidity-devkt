...
public class SolAssemblyFunctionDefinitionImpl extends ASTWrapperPsiElement implements SolAssemblyFunctionDefinition {

  public SolAssemblyFunctionDefinitionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitAssemblyFunctionDefinition(this);
  }
