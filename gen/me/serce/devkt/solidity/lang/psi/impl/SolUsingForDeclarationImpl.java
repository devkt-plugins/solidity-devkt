...
public class SolUsingForDeclarationImpl extends ASTWrapperPsiElement implements SolUsingForDeclaration {

  public SolUsingForDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitUsingForDeclaration(this);
  }
