...
public class SolEmitStatementImpl extends ASTWrapperPsiElement implements SolEmitStatement {

  public SolEmitStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SolFunctionCallExpression getFunctionCallExpression() {
    return findChildByClass(SolFunctionCallExpression.class);
  }
