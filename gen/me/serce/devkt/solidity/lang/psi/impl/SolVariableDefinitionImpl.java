...
public class SolVariableDefinitionImpl extends ASTWrapperPsiElement implements SolVariableDefinition {

  public SolVariableDefinitionImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SolVariableDeclaration getVariableDeclaration() {
    return findNotNullChildByClass(SolVariableDeclaration.class);
  }
