...
public class SolFunctionalAssemblyAssignmentImpl extends ASTWrapperPsiElement implements SolFunctionalAssemblyAssignment {

  public SolFunctionalAssemblyAssignmentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitFunctionalAssemblyAssignment(this);
  }
