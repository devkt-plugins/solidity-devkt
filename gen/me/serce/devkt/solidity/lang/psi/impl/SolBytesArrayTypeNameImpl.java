...
public class SolBytesArrayTypeNameImpl extends SolTypeNameImpl implements SolBytesArrayTypeName {

  public SolBytesArrayTypeNameImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitBytesArrayTypeName(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getBytesNumType() {
    return findNotNullChildByType(BYTESNUMTYPE);
  }
