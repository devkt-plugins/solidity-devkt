...
public class SolIndexedParameterListImpl extends ASTWrapperPsiElement implements SolIndexedParameterList {

  public SolIndexedParameterListImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitIndexedParameterList(this);
  }
