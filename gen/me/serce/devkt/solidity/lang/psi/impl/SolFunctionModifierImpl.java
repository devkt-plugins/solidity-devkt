...
public class SolFunctionModifierImpl extends ASTWrapperPsiElement implements SolFunctionModifier {

  public SolFunctionModifierImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SolStateMutability getStateMutability() {
    return findChildByClass(SolStateMutability.class);
  }
