...
public class SolSubAssemblyImpl extends ASTWrapperPsiElement implements SolSubAssembly {

  public SolSubAssemblyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitSubAssembly(this);
  }
