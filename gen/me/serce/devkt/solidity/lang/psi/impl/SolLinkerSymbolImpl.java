...
public class SolLinkerSymbolImpl extends ASTWrapperPsiElement implements SolLinkerSymbol {

  public SolLinkerSymbolImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitLinkerSymbol(this);
  }
