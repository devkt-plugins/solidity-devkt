...
public class SolParameterListImpl extends ASTWrapperPsiElement implements SolParameterList {

  public SolParameterListImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SolParameterDef> getParameterDefList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SolParameterDef.class);
  }
