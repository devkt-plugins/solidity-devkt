...
public class SolAssemblyCaseImpl extends ASTWrapperPsiElement implements SolAssemblyCase {

  public SolAssemblyCaseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitAssemblyCase(this);
  }
