...
public class SolStorageLocationImpl extends ASTWrapperPsiElement implements SolStorageLocation {

  public SolStorageLocationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SolVisitor visitor) {
    visitor.visitStorageLocation(this);
  }
