...
public class SolEnumDefinitionImpl extends ASTWrapperPsiElement implements SolEnumDefinition {

  public SolEnumDefinitionImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SolEnumValue> getEnumValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SolEnumValue.class);
  }
